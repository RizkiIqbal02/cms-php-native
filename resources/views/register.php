...
<div class="flex w-full h-screen justify-center items-center">
    ...
    <div class="card w-2/6 bg-base-100 shadow-2xl">
        ...
        <div class="card-body items-center text-center w-full">
            ...
            <form class="flex flex-row gap-3 flex-wrap justify-center" action="/register" method="post">
                <label class="form-control w-full max-w-md">
                    <div class="label">
                        <span class="label-text">What is your name?</span>
                    </div>
                    <input required autofocus type="text" name="name" placeholder="Type your name" class="input input-bordered" />
                    <div class="label">
